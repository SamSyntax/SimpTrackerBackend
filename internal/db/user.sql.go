...
func (q *Queries) GetCountsPerUserPerKeyword(ctx context.Context, id int32) (GetCountsPerUserPerKeywordRow, error) {
	row := q.db.QueryRowContext(ctx, getCountsPerUserPerKeyword, id)
	var i GetCountsPerUserPerKeywordRow
